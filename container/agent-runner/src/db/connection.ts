...
import { INBOUND_DB_PATH, OUTBOUND_DB_PATH, HEARTBEAT_PATH } from '../paths.js';

const DEFAULT_INBOUND_PATH = INBOUND_DB_PATH;
const DEFAULT_OUTBOUND_PATH = OUTBOUND_DB_PATH;
const DEFAULT_HEARTBEAT_PATH = HEARTBEAT_PATH;
